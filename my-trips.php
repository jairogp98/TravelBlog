<?php
  ...
  try{
    ...
    $sql = "SELECT * FROM trips WHERE nickname = '$nickname'"; //BUSCO LOS TRIPS
...
<html lang="es">
  ...
  <body>
          ...
          <?php
              ...
              if (isset($_SESSION["usuario"])){
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#top">My trips</a>
    ...
    <div class="wrapper">
      ...
      <div class = "d-flex m-auto justify-content-center" style = "width:90%;"><h1>My Trips</h1></div>
      <div class = "d-flex justify-content-center my-5 mx-auto" style = "width:90%;"><a href="new-trip.php" class = "btn btn-dark"><h5>New Trip</h5></a></div>  
      
      <?php

        if (!empty($dato)){
      ?>
      <div class = "trips-container mt-5">
          <?php
            for ($i=0; $i <count($dato) ; $i++) {
              $obtener_foto = $foto[$i][0]; 
          ?>    
          <div class = "trip" style = "background-image: url('data:<?php echo $obtener_foto['tipo_img']?>;base64,<?php echo base64_encode($obtener_foto['imagen']);?>'); object-fit: cover; width:100%; ">    
              <h1><?php echo $dato[$i]['ciudad'];?></h1>  
              <div class = "buttons">
              <a href="trip.php?id=<?php echo $dato[$i]['id'];?>" class = "btn btn-outline-light">View</a> 
              <a href="delete-trip.php?id=<?php echo $dato[$i]['id'];?>" class = "btn btn-outline-light">Delete</a> 
              </div>
          </div> 
          <?php
            }       
